#!/bin/bash
# Despliegue Robusto de AUDIO FORGE (Siguiendo Manual Sideload)
APP_NAME="Audio Forge"
APP_ID="audioforge.gaiamobile.org"
...
adb push "$DEV_PATH/audio_forge/manifest.webapp" "/data/local/webapps/$APP_ID/"
